...
public class ClientRender {
    ...
    public static void initRenderFixes() {
        ...
        setupFluidRendering(BlockRegistry.STILL_POISON_WATER, BlockRegistry.FLOWING_POISON_WATER, new Identifier("minecraft", "water"), 0x000000);
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), BlockRegistry.STILL_POISON_WATER, BlockRegistry.FLOWING_POISON_WATER);
    }
