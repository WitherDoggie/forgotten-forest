...
public class FFIronOre implements BakedModel, UnbakedModel, FabricBakedModel {
    ...
    private static final SpriteIdentifier[] SPRITE_IDENTIFIERS = new SpriteIdentifier[] {
            new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier(ForgottenForest.MODID, "block/mod_iron_ore"))
    };
    ...
    public BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        ...
        SPRITES[0] = textureGetter.apply(SPRITE_IDENTIFIERS[0]);
