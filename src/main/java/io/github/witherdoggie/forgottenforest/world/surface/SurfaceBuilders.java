...
public class SurfaceBuilders {
    ...
    public static final SurfaceBuilder<QuadarySurfaceConfig> SHADOW_SURFACE_BUILDER = Registry.register(Registry.SURFACE_BUILDER, new Identifier(ForgottenForest.MODID, "shadow_surface_builder"), new ModBiomeSurfaceBuilder());
